...
calc_loop:
    ...
    mov rdi, rsi                    ; адрес массива
    mov [rdi + rcx * 8], rax        ; сохраняем результат в массиве
...
; Вход: rax - число
; Выход: rsi - буфер строки, rbx - длина строки
int_to_str:
...
convert_loop:
    ...
    mov rbx, rdi                    ; сохраняем начало строки
    ret
